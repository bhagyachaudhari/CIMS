...
import java.sql.*;
import java.util.*;
public class  AdmssnReport  extends JInternalFrame implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			if(op==JFileChooser.APPROVE_OPTION)
			{
				...
				s="\n"+"\t"+"\t"+"\t"+"\t"+s+"\n"+"Student_ID"+" "+"Student_Name"+" "+"Date"+" "+"Faculty"+" "+"Course_Name"+" "+"Course_Fees"+" "+"Admission_Fees"+"\n";
		...
		if(e.getSource()==show)
		{
			try
			{
				...
				ResultSet rs=st.executeQuery("select Student_ID,Student_Name,Date_of_Admission,Faculty,Course_Name,Total_Course_Fees,Total_Adm_Fees from admission");
		...
		if(e.getSource()==search)
		{
			...
			try
			{
				...
				Statement st=con.createStatement();
				ResultSet rs=st.executeQuery("select Student_ID,Student_Name,Date_of_Admission,Faculty,Course_Name,Total_Course_Fees,Total_Adm_Fees from admission where Student_ID="+tsearch.getText());
				ResultSetMetaData rsmd=rs.getMetaData();
