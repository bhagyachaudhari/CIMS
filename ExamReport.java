...
import java.sql.*;
import java.util.*;
public class  ExamReport  extends JInternalFrame implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			if(op==JFileChooser.APPROVE_OPTION)
			{
				...
				s="\n"+"\t"+"\t"+"\t"+"\t"+s+"\n"+"Student_ID"+" "+"Name"+" "+"Gender"+" "+"Course_Name"+" "+"Seat_No"+" "+"Center"+" "+"Date"+" "+"Timing"+"\n";
		...
		if(e.getSource()==show)
		{
			try
			{
				...
				ResultSet rs=st.executeQuery("select Student_ID,Student_Name,Gender,Course_Name,Seat_No,Exam_Center,Exam_Date,Exam_Time from exam");
		...
		if(e.getSource()==search)
		{
			...
			try
			{
				...
				Statement st=con.createStatement();
				ResultSet rs=st.executeQuery("select Student_ID,Student_Name,Gender,Course_Name,Seat_No,Exam_Center,Exam_Date,Exam_Time from exam where Student_ID="+tsearch.getText());
				ResultSetMetaData rsmd=rs.getMetaData();
