...
public class FInstallmentReport extends JInternalFrame implements ActionListener
{
	JScrollPane sp;
	...
	FInstallmentReport()
	{
		...
		setClosable(true);	
		setSize(885,540);
		setTitle("Fees Installment Report");
	}
public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			if(op==JFileChooser.APPROVE_OPTION)
			{
				...
				try
				{
				String s="Computer Institute Management System\n"+"\t"+"\t"+"\t"+"\t"+"\t"+"Fees Installment Report\n\n";
				s="\n"+"\t"+"\t"+"\t"+"\t"+s+"\n"+"Student_ID"+" "+"I_Date"+" "+"Student_Name"+" "+"Course_Name"+" "+"Faculty"+" "+"Total_Fees"+" "+"No_of_installments"+" "+"Fees_Paid"+" "+"Balance_Fees"+" "+"Current_Pay"+" "+"Remaining"+"\n";
		...
		if(e.getSource()==show)
		{
			try
			{
				...
				ResultSet rs=st.executeQuery("select Student_ID, I_Date, Student_Name,Course_Name, Faculty, Total_Fees, No_Of_Installments, Fees_Paid, Balance_Fees, Current_Pay_Fees, Remaining_Installments from fees");
		...
		if(e.getSource()==search)
		{
			...
			try
			{
				...
				Statement st=con.createStatement();
				ResultSet rs=st.executeQuery("select Student_ID, I_Date, Student_Name,Course_Name, Faculty, Total_Fees, No_Of_Installments, Fees_Paid, Balance_Fees, Current_Pay_Fees, Remaining_Installments from fees where Student_ID="+tsearch.getText());
				ResultSetMetaData rsmd=rs.getMetaData();
