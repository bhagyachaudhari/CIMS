...
import java.sql.*;
import java.util.*;
public class FeesReceiptReport extends JInternalFrame implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			if(op==JFileChooser.APPROVE_OPTION)
			{
				...
				s="\n"+"\t"+"\t"+"\t"+"\t"+s+"\n"+"Student_ID"+" "+"Date"+" "+"Receipt No"+" "+"Name"+" "+"Address"+" "+"Course"+" "+"By Cash"+" "+"Drawn on"+" "+"Rupees"+"\n";
		...
		if(e.getSource()==show)
		{
			try
			{
				...
				ResultSet rs=st.executeQuery("select Student_ID,F_Date,Receipt_No,Student_Name,Address,Course_Name,By_Cash,Drawn_On,Rupees from receipt");
		...
		if(e.getSource()==search)
		{
			...
			try
			{
				...
				Statement st=con.createStatement();
				ResultSet rs=st.executeQuery("select Student_ID,F_Date,Receipt_No,Student_Name,Address,Course_Name,By_Cash,Drawn_On,Rupees from receipt where Student_ID="+tsearch.getText());
				ResultSetMetaData rsmd=rs.getMetaData();
