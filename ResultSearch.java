...
public class ResultSearch extends JInternalFrame implements ActionListener
{
	Container cp;
	...
	ResultSearch()
	{
		...
		cp.add(bsearch);
		bsearch.setBounds(145,450,70,25);
		bsearch.setFont(f1);
		...
		cp.add(breset);	
		breset.setBounds(245,450,70,25);
		breset.setFont(f1);
		...
		setVisible(true);
		setSize(590,525);
		setTitle("Search for Result Details");
	}
