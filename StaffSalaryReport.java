...
import java.sql.*;
import java.util.*;
public class  StaffSalaryReport extends JInternalFrame implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			if(op==JFileChooser.APPROVE_OPTION)
			{
				...
				s="\n"+"\t"+"\t"+"\t"+"\t"+s+"\n"+"Staff_ID"+" "+"Date"+" "+"Payslip No"+" "+"Staff Name"+" "+"Address"+" "+"Salary"+"\n";
		...
		if(e.getSource()==show)
		{
			try
			{
				...
				ResultSet rs=st.executeQuery("select Staff_ID,S_Date,Payslip_No,Staff_Name,Address,Salary from salary");
		...
		if(e.getSource()==search)
		{
			...
			try
			{
				...
				Statement st=con.createStatement();
				ResultSet rs=st.executeQuery("select Staff_ID,S_Date,Payslip_No,Staff_Name,Address,Salary from salary where Staff_ID="+tsearch.getText());
				ResultSetMetaData rsmd=rs.getMetaData();
