...
import java.sql.*;
import java.util.*;
public class  StudReport  extends JInternalFrame implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==print)
		{
			...
			if(op==JFileChooser.APPROVE_OPTION)
			{
				...
				s="\n"+"\t"+"\t"+"\t"+"\t"+s+"\n"+"Student_ID"+" "+"Student_Name"+" "+"Address"+" "+"Phone_No"+" "+"Date_Of_Birth"+" "+"Gender"+" "+"Course_Name"+"\n";
		...
		if(e.getSource()==show)
		{
			try
			{
				...
				ResultSet rs=st.executeQuery("select Student_ID,Student_Name,Address,Phone_No,Date_Of_Birth,Gender,Course_Name from student");
		...
		if(e.getSource()==search)
		{
			...
			try
			{
				...
				Statement st=con.createStatement();
				ResultSet rs=st.executeQuery("select Student_ID,Student_Name,Address,Phone_No,Date_Of_Birth,Gender,Course_Name from student where Student_ID="+tsearch.getText());
				ResultSetMetaData rsmd=rs.getMetaData();
